...
<head>
  <meta charset="UTF-8">
  <title>Contact Us | Quiz-Verse</title>
      ...
      <div class="col-lg-7">
        <form id="contactForm" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <button type="submit" class="btn btn-accent px-4 py-2 w-100 w-md-auto">Send Message</button>
              <p id="formSuccessMsg" class="text-success small mt-3 mb-0">✓ Message sent — thanks for reaching out! We'll reply soon.</p>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-lg-5">
        ...
        <div class="contact-detail">
          ...
          <div>
            ...
            <div class="text-muted small">quiz-verse@gmail.com</div>
          </div>
        </div>
        <div class="contact-detail">
          <span class="contact-icon">#</span>
          <div>
            ...
            <div class="text-muted small">+94 77 076 5430</div>
          </div>
        </div>
        <div class="contact-detail">
          <span class="contact-icon">◎</span>
          <div>
            ...
            <div class="text-muted small">Mihintale, Sri Lanka</div>
          </div>
        </div>
